...
/**
 * Pedido creado por el equipo del restaurante.
 *
 * A diferencia del pedido público, el nombre de la persona es opcional: la
 * mesa, dirección o modalidad identifican el pedido y el servicio usa un
 * valor de respaldo interno para mantener el dato histórico requerido por orders.
 */
