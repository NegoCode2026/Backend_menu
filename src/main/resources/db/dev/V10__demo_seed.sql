-- V10 (SOLO DEV): Datos de demostración.
-- Este archivo se ejecuta únicamente en el perfil de desarrollo, porque
-- application.yml solo incluye classpath:db/dev en su flyway.locations.
-- NUNCA incluir credenciales demo conocidas en producción.
